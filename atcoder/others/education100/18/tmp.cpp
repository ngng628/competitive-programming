...
signed main()
{
    vector<int> v = {1, 1, 2, 5, 7, 7, 9};
    Print(v);
    cout << "upper_bound(ALL(v), 7) : " << *upper_bound(ALL(v), 7) << endl;
    cout << "lower_bound(ALL(v), 7) : " << *lower_bound(ALL(v), 7) << endl;
    cout << "lower_bound(ALL(v), 7)-1 : " << *(lower_bound(ALL(v), 7) - 1) << endl;
    cout << "upper_bound(ALL(v), 8) : " << *upper_bound(ALL(v), 8) << endl;
    cout << "lower_bound(ALL(v), 8) : " << *lower_bound(ALL(v), 8) << endl;
    cout << "lower_bound(ALL(v), 8)-1 : " << *(lower_bound(ALL(v), 8) - 1) << endl;
    cout << "upper_bound(ALL(v), 10) : " << *upper_bound(ALL(v), 10) << endl;
    cout << "lower_bound(ALL(v), 10) : " << *lower_bound(ALL(v), 10) << endl;
    cout << "lower_bound(ALL(v), 10)-1 : " << *(lower_bound(ALL(v), 10) - 1) << endl;
