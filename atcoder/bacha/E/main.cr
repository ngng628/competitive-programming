...
f = ->(dp_c : Monoid, c : Int64){ Monoid.new(dp_c.dist + dp_c.n_childs, dp_c.n_childs) }
merge = ->(dp_i : Monoid, dp_j : Monoid){ Monoid.new(dp_i.dist + dp_j.dist, dp_i.n_childs + dp_j.n_childs) }
e = ->(){ Monoid.new(0_i64, 0_i64) }
g = ->(dp_v : Monoid, v : Int64){ Monoid.new(dp_v.dist, dp_v.n_childs + 1) }
