...
int main()
{
    ...
    {
        int64 cur = 1;
        for (int64 y : Range(1, N))
        {
            bool flag = false;
            for (int64 x : Range(1, N))
            {
                if (x == cur and y % 3 != 0)
                {
                    cout << "a";
    ...
    else if (N%5 == 0)
    {
        ...
        char c[2] = {'c', 'd'};
        for (int64 y : Range(0, N-1))
        {
            bool flag = false;
            int64 cnt1 = 0;
            for (int64 x : Range(0, N-1))
            {
                if (y == 0)
                {
                    str[y][x] = c[cnt1/2];
    ...
    else if (N%8 == 0)
    {
        ...
        for (int64 y : Range(0, N-1))
        {
            ...
            for (int64 x : Range(0, N-1))
            {
                ...
                {
                    if (str[y][x] == 'x' or str[y][x] == 'y')
                    {
                    }
                    else if (x == cur and y % 3 != 0)
                    {
                        str[y][x] = 'a';
                        str[y][N-x-1] = 'x';
                    }
