...
a, b, d = ints
theta = Math.acos(-1.to_f64) * d.to_f64 / 180.0
a2 = a.to_f64 * Math.cos(theta) - b.to_f64 * Math.sin(theta)
b2 = a.to_f64 * Math.sin(theta) + b.to_f64 * Math.cos(theta)

puts printf("%.7f %.7f", a2, b2)