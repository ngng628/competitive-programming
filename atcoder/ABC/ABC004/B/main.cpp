...
# endif
	...
	inline Array<String> ReadLines(size_t n) { Array<String> ss(n); for (size_t i = 0; i < n; ++i) { ss[i] = ReadLine(); } return ss; }
...
void Main()
{
    Array<String> ss = ReadLines(4);
    ss.reverse();
    ss.each([](String& s){ reverse(s.begin(), s.end()); Print << s;});
}
