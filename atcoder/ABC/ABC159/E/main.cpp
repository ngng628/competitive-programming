...
int32 calc(const Array<Array<int32>>& sums, int32 x1, int32 x2, int32 y1, int32 y2)
{
...
int main()
{
    int32 H = ReadInt(), W = ReadInt(), K = ReadInt();
    Array<String> S = ReadWordArray(H);
    Array<Array<int32>> A(H, Array<int32>(W));
    for (int32 y : step(H))
    {
        for (int32 x : step(W))
        {
    ...
    Array<Array<int32>> sums(H+1, Array<int32>(W+1, 0));
    for (int32 y : step(H))
    {
            for (int32 x : step(W))
        {
