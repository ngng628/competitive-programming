...
int main()
{
    Array<Array<int32>> A(3, Array<int32>(3, 0));
    for (int32 i : step(3))
    {
        for (int32 k : step(3))
        {
    ...
    int32 N = ReadInt();
    Array<Array<int32>> bingo(3, Array<int32>(3, 0));
    for (int32 i : step(N))
    {
        int32 b = ReadInt();
        for (int32 i : step(3))
    ...
    for (int32 y : step(3))
    {
        if (bingo[y][0] == 1 and bingo[y][1] == 1 and bingo[y][2] == 1)
        {
            Print << "Yes";
            return 0;
        }
    ...
    for (int32 x : step(3))
    {
        if (bingo[0][x] == 1 and bingo[1][x] == 1 and bingo[2][x] == 1)
        {
            Print << "Yes";
            return 0;
        }
