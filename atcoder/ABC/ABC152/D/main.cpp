...
int main()
{
    ...
    for (int32 i : Range(1, Nmax))
    {
        ...
        else if (11 <= i and i <= 99)
        {
            ...
            else if (d2 >= d1 and d1 != 0 and d2 != 0)
            {
        ...
        else
        {
            ...
            int32 d2 = GetDigit(i, d.length() - 1);

            if (d1 == 0 and d2 == 0) continue;
            dp[i] = dp[i-1] + dp[10*d2 + d1];
        }
    }
    Print << dp[N];
...
//    for (int32 bA : Range(1, 9))
//    {
//        for (int32 eA : Range(0, 9))
//        {
//            for (int32 eB : Range(1, 9))
//            {
//                for (int32 eB : Range(0, 9))
//                {
//
//                }
//            }
