...
{
    int64 N = ReadInt64();
    Array<int64> a = ReadInt64Array(N);
    // 2 2 4 3 4 2
    // [2 2] 2 2 2 2
    // 2 2 4 x 4 2
    // 2 2 2 4 1
    ...
    // 0 4&2  2
    // x 4 x 4 x 4 x
    int64 M4_num = a.count_if(isM4);
    int64 M2_num = a.count_if(isM2) - M4_num;
    int64 Mk_num = len(a) - M4_num - M2_num;

    if (M2_num == 0)
    {
        Print <<  YesNo(Mk_num - 1 <= M4_num);
        Print << "a";
    }
    else
    {
        Print <<  YesNo(Mk_num <= M4_num);
    }
